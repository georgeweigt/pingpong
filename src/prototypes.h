...
void ec_init(void);
int ec_ecdh(uint8_t *ecdh_key, uint8_t *private_key, uint8_t *public_key);
void ec_genkey(uint8_t *private_key, uint8_t *public_key);
int ec_genkey_from_random(uint8_t *private_key, uint8_t *public_key, uint8_t *randbytes);
void ec_get_public_key(uint8_t *public_key_x, uint8_t *public_key_y, uint8_t *private_key);
void test_ec_genkey(void);
void ec_secret(uint8_t *secret, uint8_t *k, uint8_t *public_key);
...
uint8_t * ecies_encrypt(struct node *p, uint8_t *msg, int msglen, int hdrlen, int *plen);
