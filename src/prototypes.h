...
void encrypt(uint8_t *rbuf, uint8_t *sbuf, uint8_t *hash, uint8_t *private_key);
...
int main();
void stub(void);
void mint_key(uint8_t *private_key, uint8_t *public_key_x, uint8_t *public_key_y);
void test_mint_key(void);
void selftest(void);
