...
int test_public_keys_secp256k1(uint32_t *x, uint32_t *y);
...
int ping_payload(uint8_t *outbuf, char *src_ip, char *dst_ip, int src_port, int dst_port);
struct atom * ping_data(char *src_ip, char *dst_ip, int src_port, int dst_port);
void test_ping_payload(void);
void sign(uint8_t *sig, uint8_t *msg, int msglen);
void test_sign(void);
