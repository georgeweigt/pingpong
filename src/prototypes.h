...
int main();
void stub(void);
void send_ping_packet(int fd, char *src_ip, char *dst_ip, int src_port, int dst_port, uint8_t *public_key_x, uint8_t *public_key_y);
int ping_payload(uint8_t *outbuf, char *src_ip, char *dst_ip, int src_port, int dst_port, uint8_t *public_key_x, uint8_t *public_key_y);
