...
void aes128ctr_setup(uint32_t *state, uint8_t *key, uint8_t *iv);
void aes128ctr_encrypt(uint32_t *state, uint8_t *buf, int len);
...
void compress_emit_mem(struct compress_state_t *p, int k, int len);
int decap(uint8_t *buf, int len, uint8_t *private_key);
uint8_t * decompress(uint8_t *inbuf, int inlength, int *plen);
int decompress_nib(uint8_t *outbuf, int outmax, uint8_t *inbuf, int inlength);
int decompress_length(uint8_t *inbuf, int inlength, int *inindex);
...
void ec_sign(uint8_t *sig, uint8_t *hash, uint8_t *private_key);
void ec_sign_rfc6979(uint8_t *sig, uint8_t *hash, uint8_t *private_key);
...
void pingpong(void);
void pingpong_nib(struct node *p);
...
int send_frame(struct node *p, struct atom *msgid, struct atom *msgdata);
int send_frame_uncompressed(struct node *p, struct atom *msgid, struct atom *msgdata);
void encap_frame(struct node *p, uint8_t *framebuf, int framelen);
