...
void ec_double_v2(struct point *R, struct point *S, uint32_t *p);
...
void test_public_keys_secp256k1(uint32_t *x, uint32_t *y, uint32_t *p);
void test_public_keys_secp256r1(uint32_t *x, uint32_t *y, uint32_t *p);
